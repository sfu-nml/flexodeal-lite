...
- Clone the repository using your SSH keys: ```git clone git@github.com:sfu-nml/flexodeal-lite.git```. Download the repository as a .zip if you do not want to track your changes or you do not have a GitHub account.
